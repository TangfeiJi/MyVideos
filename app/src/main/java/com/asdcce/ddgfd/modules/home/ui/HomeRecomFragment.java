...
public class HomeRecomFragment extends BaseFragment<LocationPresenter> implements LocationContract.View, SwipeRefreshLayout.OnRefreshListener,
        OnLoadMoreListener {
    ...
    public static HomeRecomFragment newInstance() {
