...
package com.asdcce.ddgfd.core.db;

import android.database.sqlite.SQLiteDatabase;

import com.asdcce.ddgfd.application.MyApplication;
import com.asdcce.ddgfd.core.constant.Constants;
import com.asdcce.ddgfd.core.greendao.DaoMaster;
import com.asdcce.ddgfd.core.greendao.DaoSession;
import com.asdcce.ddgfd.core.greendao.HistoryData;
import com.asdcce.ddgfd.core.greendao.HistoryDataDao;
...
public class DbHelperImpl implements DbHelper {
    ...
    private void initGreenDao() {
        DaoMaster.DevOpenHelper devOpenHelper =
                new DaoMaster.DevOpenHelper(MyApplication.getContext(), Constants.DB_NAME);
